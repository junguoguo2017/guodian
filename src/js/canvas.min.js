...
var Color = {
    ...
    hexToRgb: function(t) {
        ...
        if (/^#([0-9a-f]{3}|[0-9a-f]{6})$/.test(e))
            for (var o = 4 == e.length ? 1 : 2, r = 1; r < 3 * o + 1; r += o)
    ...
    rgbToHsl: function(t) {
        ...
        o = (u + s) / 2;
        var c = u - s;
        return e = 0 == c ? 0 : c / (1 - Math.abs(2 * o - 1)),
        n = 0 == e ? 0 : r == u ? (a - i) / c % 6 : a == u ? (i - r) / c + 2 : (r - a) / c + 4,
        n *= 60,
        n < 0 && (n += 360),
        [Math.round(n), (100 * e).toFixed(1), (100 * o).toFixed(1)]
    },
    hslToRgb: function(t) {
        var n = parseFloat(t[0] / 360, 10)
          , e = parseFloat(t[1] / 100, 10)
          , o = parseFloat(t[2] / 100, 10);
        if (0 == e) {
        ...
        for (var r = o >= .5 ? o + e - o * e : o * (1 + e), a = 2 * o - r, i = [1 / 3, 0, -1 / 3], u = 0; u < 3; u++) {
            ...
            s < 0 && (s += 1),
            s > 1 && (s -= 1),
            s = 6 * s < 1 ? a + 6 * (r - a) * s : 2 * s < 1 ? r : 3 * s < 2 ? a + (r - a) * (2 / 3 - s) * 6 : a,
            i[u] = Math.ceil(255 * s)
        }
        return i
    },
  ...
  , Tween = {
    ...
    elastic: function(t, n, e, o, r, a) {
        ...
        !r || r < Math.abs(e)) {
            ...
            var i = a / (2 * Math.PI) * Math.asin(e / r);
